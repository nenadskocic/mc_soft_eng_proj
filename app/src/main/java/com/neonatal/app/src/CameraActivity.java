...
public class CameraActivity extends AppCompatActivity {
    ...
    private void getPic() {
        ...
        try {
            ...
            final CameraCaptureSession.CaptureCallback cameraCaptureSession = new CameraCaptureSession.CaptureCallback() {
                @Override
            ...
            cameraDevice.createCaptureSession(outputSurfaces, new CameraCaptureSession.StateCallback() {
                ...
                public void onConfigured(CameraCaptureSession session) {
                    try {
                        session.capture(capturebuilder.build(), cameraCaptureSession, handler);
                    } catch (Exception e) {
                    }
                }
    ...
    private static File getOutputMediaFile() {
        ...
        if (!mediaStorageDir.exists()) {
            if (!mediaStorageDir.mkdirs()) {
                Log.d("NeonatalNurseries", "failed to create directory");
                return null;
            }
        }
